...
//audio clips -- if chose to do
let audio = new Audio('assets//...hp theme?');
...
let characters = {
    ...
    'dumbledore': {
        ...
        health: 200,
        attack: 14,
        imageUrl: "assets/images/dumbl.png",
        enemyAttackBack: 5
    }, 
    'belatrix': {
        name: 'belatrix',
        health: 150,
        attack: 8,
        imageUrl: "assets/images/bellatrix.jpg",
        enemyAttackBack: 20
    }, 
    'voldemort': {
        name: 'voldemort',
        health: 180,
        attack: 7,
        imageUrl: "assets/images/vold.jpeg",
        enemyAttackBack: 20
    }
};
...
var renderOne = function(character, renderArea, makeChar) {
  ...
  // Create function for g ame message to DOM
  ...
  //render all characters for user to choose their computer
    ...
    if ($('#defender').children().length !== 0) {
      ...
      if (currDefender.health > 0) {
        ...
        if (currSelectedCharacter.health <= 0) {
          renderMessage("clearMessage");
          restartGame("You've Lost your Battle.");
          force.play();
        ...
        if (killCount >= 3) {
          renderMessage("clearMessage");
          restartGame("Expecto Patronum! You've won the Battle of Hogwarts!");
          jediKnow.play();
...
//Restarts the game - reset button
